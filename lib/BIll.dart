...
import 'package:pilllist/main.dart';
...
class _nameState extends State<name> {
  ...
  Future<void> _selectDate(BuildContext context) async {
    ...
    if (picked != null && picked != selectedDate) {
      setState(() {
        selectedDate = picked;
        mdate.text = selectedDate.toString().substring(0, 10);
      });
    }
  }
  ...
  Future<void> _selectDateex(BuildContext context) async {
    ...
    if (picked != null && picked != selectedDateex) {
      setState(() {
        ...
        exdate.text = selectedDateex
            .toString()
            .substring(0, 10); // Update the TextField value
      });
    }
  }
  ...
  Future<void> _selectDatepur(BuildContext context) async {
    ...
    if (picked != null && picked != selectedDatepur) {
      setState(() {
        ...
        purchasedate.text = selectedDatepur
            .toString()
            .substring(0, 10); // Update the TextField value
      });
    }
